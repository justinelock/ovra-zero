...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2801', 'App品牌资源', '328198489278255104', 1, 'main', 'biz/appBrand/main/index', '', 1, 0, 'C', '0', '0', 'appBrand:main:list', 'mdi:earth', 103, 1, '2026-06-24 23:27:45', 1, '2026-06-24 23:44:41', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query_param`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_dept`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('2901', 'App版本管理', '328198489278255104', 1, 'main', 'biz/appVersion/main/index', '', 1, 0, 'C', '0', '0', 'appVersion:main:list', 'mdi:view-grid', 103, 1, '2026-06-24 23:27:45', 1, '2026-06-24 23:44:50', '');
